...
public class ModelsGenerator {
    public static void generate() {
        NotEnoughChests.WOOD_TYPES.forEach(wt->{
            String t = wt.getPath();
            itemFromParent(ModAbbreviation.getModAbbreviation(wt.getNamespace()) + t + "_chest", MODID + ":item/chest_base", new TextureKey("wood_type", MODID + ":entity/chest/chest_single/" + ModAbbreviation.getChestTexture(wt)));
            blockFromParent(ModAbbreviation.getModAbbreviation(wt.getNamespace()) + t + "_chest", "minecraft:block/chest", new TextureKey("particle", MODID + ":entity/chest/chest_single/" + ModAbbreviation.getChestTexture(wt)));
            itemFromParent(ModAbbreviation.getModAbbreviation(wt.getNamespace()) + t + "_trapped_chest", MODID + ":item/chest_base", new TextureKey("wood_type", MODID + ":entity/chest/chest_trapped_single/" + ModAbbreviation.getChestTexture(wt)));
            blockFromParent(ModAbbreviation.getModAbbreviation(wt.getNamespace()) + t + "_trapped_chest", "minecraft:block/chest", new TextureKey("particle", MODID + ":entity/chest/chest_trapped_single/" + ModAbbreviation.getChestTexture(wt)));
        });
    }
